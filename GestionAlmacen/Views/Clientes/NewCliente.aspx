    ...
    <div class="jumbotron">
        ...
        <% using (Html.BeginForm()) { %>
           ...
           <div class="row margin-top">
               ...
               <div class="col-sm-10"><%: Html.TextBoxFor(m => m.Pais, new { @class = "form-control", @type = "text", @pattern = "^([_A-z]){3,}$", @maxlength = "40", @minlength = "9", @required = "required" })%></div>
           </div>
           <div class="row margin-top">
               <div class="col-sm-2"><strong>Provincia</strong></div>
               <div class="col-sm-10"><%: Html.TextBoxFor(m => m.Provincia, new { @class = "form-control", @type = "text", @pattern = "^([_A-z]){3,}$", @maxlength = "50", @minlength = "9", @required = "required" })%></div>
           </div>
           <div class="row margin-top">
           ...
           <div class="row margin-top">
               ...
               <div class="col-sm-10"><%: Html.TextBoxFor(m => m.DireccionEnvio, new { @class = "form-control", @type = "text", @pattern = "^([_A-z0-9]){3,}$", @maxlength = "70", @minlength = "9", @required = "required" })%></div>
           </div>
           <div class="row margin-top">
